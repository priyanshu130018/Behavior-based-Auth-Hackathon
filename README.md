...
* Modern web browser
* Git
* Node.js (optional, only needed when frontend development tooling is used)
...
No license file was provided in the original repository.

Please select and add your project's chosen license file (for example, MIT or Apache 2.0) before publishing a public or production release.

---

## 🤝 Credits & Acknowledgments

This project is a derivative work based on the original **Behavior-based-Auth-Hackathon** repository created by **Priyanshu Ranjan Verma (`priyanshu130018`)**.
